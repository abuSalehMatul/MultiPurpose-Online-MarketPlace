                            ...
                            @if (!empty($accepted_proposal))
                                ...
                                <div class="wt-managejobcontent">
                                    @php
                                        ...
                                        $completion_time = !empty($accepted_proposal->completion_time) ? \App\JobModel\JobHelper::getJobDurationList($accepted_proposal->completion_time) : '';
                                        ...
                                        <div class="wt-managejobcontent">
                                            @foreach ($proposals as $proposal)
                                                @php
                                                    ...
                                                    $stars  = $reviews->sum('avg_rating') != 0 ? $reviews->sum('avg_rating')/20*100 : 0;
                                                    $feedbacks = \App\Review::select('feedback')->where('receiver_id', $proposal->freelancer_id)->count();
                                                    $completion_time = !empty($proposal->completion_time) ? \App\Job\Helper::getJobDurationList($proposal->completion_time) : '';
