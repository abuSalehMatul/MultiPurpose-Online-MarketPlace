    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 float-left" id="post_job">
            ...
            <div class="wt-haslayout wt-post-job-wrap">
                {!! Form::open(['url' => url('Job/job/post-job'),'method' => 'POST','files' =>true,'enctype'=>'multipart/form-data', 'class' =>'post-job-form wt-haslayout', 'id' => 'post_job_form',]) !!}
                        ...
                        <div class="wt-dashboardboxcontent">
                            ...
                            <div class="wt-attachmentsholder">
                                <div class="lara-attachment-files">
                                    ...
                                    <job_attachments :temp_url="'{{url('Job/job/upload-temp-image')}}'"></job_attachments>
