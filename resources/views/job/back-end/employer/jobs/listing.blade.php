                                    ...
                                    <div class="wt-userlistinghold wt-userlistingholdvtwo {{$featured_class}}">
                                        ...
                                        <div class="wt-userlistingcontent">
                                            <div class="wt-contenthead">
                                                <div class="wt-title">
                                                    <a href="{{{ url('Job/profile/'.$job->employer->slug) }}}">@if($verified_user === 1)<i class="fa fa-check-circle"></i>@endif {{{$job->employer->first_name.' '.$job->employer->last_name}}}</a>
                                                    <h2>{{{$job->title}}}</h2>
                                                </div>
                                            ...
                                            <div class="wt-viewjobholder">
                                                <ul>
                                                    ...
                                                    <li><span><i class="far fa-clock wt-viewjobclock"></i>{{{ trans('lang.duration') }}} {{{ \App\JobModel\JobHelper::getJobDurationList($job->duration)}}}</span></li>
