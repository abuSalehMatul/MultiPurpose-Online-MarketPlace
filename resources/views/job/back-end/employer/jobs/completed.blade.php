    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="wt-dashboardbox">
                ...
                <div class="wt-dashboardboxcontent wt-jobdetailsholder la-jobjectc-completed">
                        ...
                        @if(!empty($completed_jobs) && $completed_jobs->count() > 0)
                            <div class="wt-managejobcontent wt-verticalscrollbar mCustomScrollbar _mCS_1">
                                @foreach ($completed_jobs as $job)
                                    @php
                                        $accepted_jobposal = \App\JobModel\JobJob::find($job->id)->proposals()->where('status', 'completed')->first();
                                        ...
                                        <div class="wt-userlistingcontent wt-userlistingcontentvtwo">
                                            ...
                                            <div class="wt-rightarea">
                                                <div class="wt-btnarea">
                                                    ...
                                                    <a href="{{{ url('Job/proposal/'.$job->slug.'/'.$job->status) }}}" class="wt-btn">{{ trans('lang.view_detail') }}</a>
                                                </div>
