                                                        ...
                                                        <div class="wt-contenthead wt-followcomhead">
                                                            <div class="wt-title">
                                                                    <a href="{{{ url('Job/profile/'.$user->slug) }}}">
                                                                        ...
                                                                        @endif
                                                                <h3><a href="{{{ url('Job/profile/'.$user->slug) }}}">{{{ $user_name }}}</a></h3>
                                                            </div>
                                                            <ul class="wt-followcompomy-breadcrumb wt-userlisting-breadcrumb">
                                                                <li><a href="{{{ url('Job/profile/'.$user->slug) }}}"> {{ trans('lang.open_jobs') }}  </a></li>
                                                                <li><a href="{{ url('Job/profile/'.$user->slug) }}"> {{ trans('lang.full_profile') }}</a></li>
