                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-4 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open([ 'url' => 'Job/admin/store-review-options', 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory', 'id' => 'review_options']) !!}
                            <fieldset>
                                            ...
                                            <tr class="del-{{{ $option->id }}}" v-bind:id="optionID">
                                                ...
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        <a href="{{{ url('Job/admin/review-options/edit-review-options') }}}/{{{ $option->id }}}" class="wt-addinfo wt-dpts">
