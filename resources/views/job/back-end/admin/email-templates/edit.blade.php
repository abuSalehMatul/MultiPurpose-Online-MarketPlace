                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open(['url' => url('Job/admin/email-templates/update-templates/'.$template->id.''),
                                'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory', 'id' => 'update_email_templates'] )
                            !!}
                            <fieldset>
                                <div class="form-group">
                                    {!! Form::text( 'title', e($template->title), ['class' =>'form-control'] ) !!}
                                </div>
                                <div class="form-group">
                                        {!! Form::text( 'subject', e($template->subject), ['class' =>'form-control'] ) !!}
                                    </div>
                                <div class="form-group">
