            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 float-right">
                ...
                <div class="wt-dashboardbox">
                    <div class="wt-dashboardboxtitle wt-titlewithsearch">
                        ...
                        {!! Form::open(['url' => url('Job/admin/email-templates'),
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="wt-actionbtn">
                                                <a href="{{{url('Job/admin/email-templates/'.$template->id)}}}" class="wt-addinfo wt-skillsaddinfo"><i class="lnr lnr-pencil"></i></a>
