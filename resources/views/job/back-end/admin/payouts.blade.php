            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-9 float-right" id="invoice_list">
                <div class="wt-dashboardbox wt-dashboardinvocies">
                    <div class="wt-dashboardboxtitle wt-titlewithsearch wt-titlewithbtn">
                        ...
                        @if ($selected_year)
                            <a href="{{url('Job/admin/payouts/download/'.$selected_year)}}" class="wt-btn"> {{ trans('lang.download') }}</a>
                        @endif
                        {!! Form::open(['url' => url('Job/admin/payouts'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch', 'id'=>'payout_year_filter']) !!}
