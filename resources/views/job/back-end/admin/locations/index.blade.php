                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open(['url' => url('Job/admin/store-location'), 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory', 'id'=>'location_form'])!!}
                            <fieldset>
                                ...
                                <div class="wt-settingscontent">
                                    <div class = "wt-formtheme wt-userform">
                                        <upload-image
                                            ...
                                            :url="'{{url('Job/admin/locations/upload-temp-image')}}'"
                                            :name="'uploaded_image'"
                                            >
                                        </upload-image>
                                                ...
                                                <tr class="del-{{{ $location->id }}}" v-bind:id="locationID">
                                                    ...
                                                    <td>
                                                        <div class="wt-actionbtn">
                                                            <a href="{{{ url('Job/admin/locations/edit-locations') }}}/{{{ $location->id }}}" class="wt-addinfo wt-skillsaddinfo"><i class="lnr lnr-pencil"></i></a>
                                                            <delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{$location->id}}'" :message="'{{trans("lang.ph_location_delete_message")}}'" :url="'{{url('Job/admin/locations/delete-locations')}}'"></delete>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforeach
