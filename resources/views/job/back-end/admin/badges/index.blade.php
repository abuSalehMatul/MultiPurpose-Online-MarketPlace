                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
                    <div class="wt-dashboardbox  la-color-picker-form-wrapper">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open([ 'url' => url('Job/admin/store-badge'), 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory','id'=> 'categories'])!!}
                                <fieldset>
                                    ...
                                    <div class="wt-settingscontent">
                                        <div class = "wt-formtheme wt-userform la-form-error {{$errors->has('uploaded_image') ? ' is-invalid' : ''}}">
                                            <upload-image
                                                :id="'badge_image'"
                                                :img_ref="'badge_ref'"
                                                :url="'{{url('Job/admin/badges/upload-temp-image')}}'"
                                                :name="'uploaded_image'"
                                                >
                                            </upload-image>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            ...
                            {!! Form::open(['url' => url('Job/admin/badges/search'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch']) !!}
                                <fieldset>
                                    <div class="form-group">
                                            ...
                                            <tr class="del-{{{ $badge->id }}}">
                                                ...
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        <a href="{{{ url('Job/admin/badges/edit-badges') }}}/{{{ $badge->id }}}" class="wt-addinfo wt-skillsaddinfo">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        <delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{ $badge->id }}'" :message="'{{trans("lang.ph_badge_delete_message")}}'" :url="'{{url('Job/admin/badges/delete-badges')}}'"></delete>
                                                    </div>
                                                </td>
                                            </tr>
                                            @php $counter++; @endphp
