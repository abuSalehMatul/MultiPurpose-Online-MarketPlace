...
@include('job.back-end.admin.home-page-settings.sections.explore-categories')
<div class="wt-tabscontenttitle la-switch-option">
    ...
    @include('job.back-end.admin.home-page-settings.sections.background-image')
    @include('job.back-end.admin.home-page-settings.sections.start-as')
<div class="wt-tabscontenttitle la-switch-option">
...
@include('job.back-end.admin.home-page-settings.sections.download-app')
