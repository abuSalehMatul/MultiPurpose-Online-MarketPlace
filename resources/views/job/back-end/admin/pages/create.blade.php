                ...
                <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            <form method="POST" action="{{url('Job/admin/store-page')}}" accept-charset="UTF-8" id="pages" class="wt-formtheme wt-formprojectinfo wt-formcategory" @submit.prevent="submitPage('{{$page_created}}')">
                                @csrf
                                <fieldset>
                                    ...
                                    <div class="wt-securitysettings wt-tabsinfo wt-haslayout">
                                            <div class="wt-settingscontent">
                                            <ul class="wt-accountinfo" id="pages-list">
                                                <li>
