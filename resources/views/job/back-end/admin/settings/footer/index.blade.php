<div class="wt-tabscontenttitle">
    ...
    {!! Form::close() !!}
    <div class="wt-settingscontent">
        @include('job.back-end.admin.settings.footer.search-menu')
    </div>
