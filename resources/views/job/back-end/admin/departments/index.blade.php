                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open([
                                'url' => url('Job/admin/store-department'), 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory',
                                'id' => 'dpts'])
                            !!}
                                <fieldset>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            ...
                            {!! Form::open(['url' => url('Job/admin/departments/search'),
                                            ...
                                            <tr class="del-{{{ $dpt->id }}}" v-bind:id="dptID">
                                                ...
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        <a href="{{{ url('Job/admin/departments/edit-dpts') }}}/{{{ $dpt->id }}}" class="wt-addinfo wt-dpts">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        <delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{$dpt->id}}'" :message="'{{trans("lang.ph_dpt_delete_message")}}'" :url="'{{url('Job/admin/departments/delete-dpts')}}'"></delete>
                                                    </div>
                                                </td>
                                            </tr>
                                            @php $counter++; @endphp
