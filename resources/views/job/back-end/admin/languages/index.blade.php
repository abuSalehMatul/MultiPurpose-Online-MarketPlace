                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open(['url' => url('Job/admin/store-language'), 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory','id' =>
                            'languages']) !!}
                            <fieldset>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            ...
                            {!! Form::open(['url' => url('Job/admin/languages/search'), 'method' => 'get', 'class' =>'wt-formtheme wt-formsearch']) !!}
                                <fieldset>
                                    <div class="form-group">
                                            ...
                                            <tr class="del-{{{ $lang->id }}}" v-bind:id="langID">
                                                ...
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        <a href="{{{ url('Job/admin/languages/edit-langs') }}}/{{{ $lang->id }}}" class="wt-addinfo wt-skillsaddinfo">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        <delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{$lang->id}}'" :message="'{{trans("lang.ph_lang_delete_message")}}'" :url="'{{url('Job/admin/languages/delete-langs')}}'"></delete>
                                                    </div>
                                                </td>
                                            </tr>
                                            @php $counter++; @endphp
