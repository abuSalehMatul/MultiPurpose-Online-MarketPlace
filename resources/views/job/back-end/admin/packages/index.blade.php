                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5 col-xl-4 float-left">
                    <div class="wt-dashboardbox">
                        ...
                        <div class="wt-dashboardboxcontent">
                            {!! Form::open([ 'url' => url('Job/admin/store/package'), 'class' =>'wt-formtheme wt-formprojectinfo wt-formcategory', 'id' => 'packages', '@submit.prevent' => 'submitPackage', 'id' => 'package_form' ]) !!}
                                <fieldset>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-7 col-xl-8 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            ...
                            {!! Form::open(['url' => url('Job/admin/packages/search'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch']) !!}
                                <fieldset>
                                    <div class="form-group">
                                            ...
                                            <tr class="del-{{{ $package->id }}}" v-bind:id="packageID">
                                                ...
                                                <td>
                                                    <div class="wt-actionbtn">
                                                        <a href="{{{ url('Job/admin/packages/edit') }}}/{{{ $package->slug }}}" class="wt-addinfo wt-packagesaddinfo">
                                                            <i class="lnr lnr-pencil"></i>
                                                        </a>
                                                        @if ($package->trial != 1)
                                                            <delete :title="'{{trans("lang.ph_delete_confirm_title")}}'" :id="'{{$package->id}}'" :message="'{{trans("lang.ph_pkg_delete_message")}}'" :url="'{{url('Job/admin/packages/delete-package')}}'"></delete>
                                                        @endif
                                                    </div>
                                                </td>
                                            </tr>
