                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="wt-insightsitem wt-dashboardbox">
                                ...
                                :package_url="'{{url('Job/dashboard/packages/freelancer')}}'"
                                :trail="'{{$trail}}'"
                                >
                                </countdown>
                            </div>
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="wt-insightsitem wt-dashboardbox">
                                <figure class="wt-userlistingimg">
                                    {{ Helper::getImages('images/thumbnail/',$latest_cancel_project_icon, 'cross-circle') }}
                                </figure>
                                <div class="wt-insightdetails">
                                    <div class="wt-title">
                                        <h3>{{{ $cancelled_projects->count() }}}</h3>
                                        <h3>{{ trans('lang.total_cancelled_projects') }}</h3>
                                        <a href="{{{ url('Job/freelancer/jobs/cancelled') }}}">{{ trans('lang.click_view') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="wt-insightsitem wt-dashboardbox">
                                <figure class="wt-userlistingimg">
                                    {{ Helper::getImages('images/thumbnail/',$latest_ongoing_project_icon, 'cloud-sync') }}
                                </figure>
                                <div class="wt-insightdetails">
                                    <div class="wt-title">
                                        <h3>{{{ $ongoing_projects->count() }}}</h3>
                                        <h3>{{ trans('lang.total_ongoing_projects') }}</h3>
                                        <a href="{{{ url('Job/freelancer/jobs/hired') }}}">{{ trans('lang.click_view') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="wt-insightsitem wt-dashboardbox">
                                <figure class="wt-userlistingimg">
                                    {{ Helper::getImages('images/thumbnail/',$latest_pending_balance_icon, 'cart') }}
                                </figure>
                                <div class="wt-insightdetails">
                                    <div class="wt-title">
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-3">
                            <div class="wt-insightsitem wt-dashboardbox">
                                <figure class="wt-userlistingimg">
                                    {{ Helper::getImages('images/thumbnail/',$latest_current_balance_icon, 'gift') }}
                                </figure>
                                <div class="wt-insightdetails">
                                    <div class="wt-title">
                            ...
                            <table class="wt-tablecategories wt-freelancer-table">
                                ...
                                <tbody>
                                    @foreach ($ongoing_projects as $projects)
                                        @php
                                            $project = \App\JobModel\JobProposal::find($projects->id);
                                            $user = \App\User::find($project->job->user_id);
                                            $user_name = Helper::getUsername($project->job->user_id);
                                        @endphp
                                        <tr>
                                            <td data-th="Project title"><span class="bt-content"><a target="_blank" href="{{{ url('Job/freelancer/job/'.$project->job->slug) }}}">{{{ $project->job->title }}}</a></span></td>
                                            <td data-th="Hired freelancer">
                                                <span class="bt-content">
                                                    <a href="{{{url('Job/profile/'.$user->slug)}}}">
                                            ...
                                            <td data-th="Actions">
                                                <span class="bt-content">
                                                    <div class="wt-btnarea">
                                                        <a href="{{{ url('Job/freelancer/job/'.$project->job->slug) }}}" class="wt-btn">{{ trans('lang.view_detail') }}</a>
                                                    </div>
                                                </span>
                                            </td>
                                        </tr>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 float-left">
                <div class="wt-dashboardbox  wt-ongoingproject la-ongoing-projects">
                    ...
                    @if (!empty($completed_projects) && $completed_projects->count() > 0)
                        @php
                            $commision = \App\JobModel\JobSiteManagement::getMetaValue('commision');
