                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2">
                    <div class="wt-proposalholder wt-haslayout">
                        <div class="proposalhead">
                            ...
                            <a href="{{{ url('Job/job/'.$job->slug) }}}">{{{ $job->title }}}</a>
                        </div>
                            ...
                            !!}
                                ...
                                <div class="form-group">
                                    <span class="wt-select">
                                        {!! Form::select('reason', \Illuminate\Support\Arr::pluck($reasons, 'title'), null, array('class' => 'form-control', 'data-placeholder' => trans('lang.select_reason'))) !!}
                                    </span>
                                </div>
