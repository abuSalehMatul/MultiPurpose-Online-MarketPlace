                                    ...
                                    <div class="wt-userlistingcontent">
                                        ...
                                        <div class="wt-rightarea">
                                            <div class="wt-btnarea">
                                                <a href="{{{ url('Job/freelancer/job/'.$job->slug) }}}" class="wt-btn">{{ trans('lang.view_detail') }}</a>
                                                <a href="{{{ url('Job/freelancer/dispute/'.$job->slug) }}}" class="wt-btn">{{ trans('lang.raise_dispute') }}</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
