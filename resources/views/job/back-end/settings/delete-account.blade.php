                    ...
                    <div class="wt-tabscontent tab-content">
                        <div class="wt-yourdetails wt-tabsinfo">
                            ...
                            <div class="wt-formtheme wt-userform">
                                {!! Form::open(['url' => url('Job/profile/settings/delete-user'), 'class' =>'wt-formtheme wt-userform delete-user-form', '@submit.prevent' => 'deleteAccount($event)', 'id' => 'delete_acc_form' ])!!}
                                    <fieldset>
