                                ...
                                <div class="wt-userprofile">
                                    ...
                                    <div class="wt-title">
                                        ...
                                        <span>
                                            ...
                                            @endif
                                            <br>
                                            <a href="{{url('Job/profile/'.$user->slug)}}">{{ '@' }}{{{ $user->slug }}}</a>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="wt-clientfeedback la-no-record">
                                ...
                                @if (!empty($reviews) && $reviews->count() > 0)
                                    @foreach ($reviews as $key => $review)
                                        @php
                                            $job = \App\JobModel\JobJob::where('id', $review->job_id)->first();
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingsingle">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="{{{ url('Job/profile/'.$job->employer->slug) }}}">@if ($verified_user === 1)<i class="fa fa-check-circle"></i>@endif {{{ Helper::getUserName($review->user_id) }}}</a>
                                                        <h3>{{{ $job->title }}}</h3>
                                                    </div>
                                                    <ul class="wt-userlisting-breadcrumb">
                                                        <li><span><i class="fa fa-dollar-sign"></i><i class="fa fa-dollar-sign"></i> {{{ \App\JobModel\JobHelper::getProjectLevel($job->project_level) }}}</span></li>
                                                        <li>
                                                            <span>
                                                                <img src="{{{asset(App\JobModel\JobHelper::getLocationFlag($job->location->flag))}}}" alt="{{{ trans('lang.flag_img') }}}"> {{{ $job->location->title }}}
                                                            </span>
                                                        </li>
