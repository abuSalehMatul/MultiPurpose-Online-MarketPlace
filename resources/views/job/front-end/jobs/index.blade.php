                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            @include('job.front-end.jobs.filters')
                        </div>
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingholdvtwo {{$featured_class}}">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="{{ url('Job/profile/'.$job->employer->slug) }}"><i class="fa fa-check-circle"></i> {{{ Helper::getUserName($job->employer->id) }}}</a>
                                                ...
                                                <div class="wt-viewjobholder">
                                                    <ul>
                                                        ...
                                                        <li><span><i class="far fa-clock wt-viewjobclock"></i>{{{ \App\JobModel\JobHelper::getJobDurationList($job->duration)}}}</span></li>
