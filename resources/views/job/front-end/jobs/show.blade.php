                ...
                <div class="job-single wt-haslayout">
                    <div id="jobs" class="wt-twocolumns wt-haslayout">
                        ...
                        @if (!empty($job))
                            <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-left">
                                <div class="wt-proposalholder">
                                    ...
                                    @endif
                                    <div class="wt-btnarea"><a href="javascript:void(0);" @click.prevent="check_auth('{{{ url('Job/job/proposal/'.$job->slug) }}}')" class="wt-btn">{{{ trans('lang.send_propsal') }}}</a></div>
                                </div>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            @include('job.front-end.jobs.sidebar.index')
                        </div>
                    </div>
                </div>
            </div>
