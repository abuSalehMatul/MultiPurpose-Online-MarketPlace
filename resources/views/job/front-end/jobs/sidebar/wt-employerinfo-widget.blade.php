        ...
        <div class="wt-companysinfo">
            ...
            <div class="wt-title">
                @if ($job->employer->user_verified === 1)
                    <a href="{{{ url('Job/profile/'.$job->employer->slug) }}}"><i class="fa fa-check-circle"></i> {{ trans('lang.verified_company') }}</a>
                @endif
                <a href="{{{ url('Job/profile/'.$job->employer->slug) }}}"><h2>{{{ Helper::getUserName($job->employer->id) }}}</h2></a>
            </div>
