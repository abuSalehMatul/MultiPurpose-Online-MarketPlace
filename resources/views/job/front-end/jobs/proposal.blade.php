                ...
                <div class="row justify-content-md-center">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 push-lg-2" id="jobs">
                            ...
                            <div class="wt-proposalhead">
                                ...
                                <ul class="wt-userlisting-breadcrumb wt-userlisting-breadcrumbvtwo">
                                    ...
                                    @if (!empty($job->project_type))
                                        <li><span class="wt-clicksavefolder"><i class="far fa-folder wt-viewjobfolder"></i> {{ trans('lang.type') }} {{{ $job->project_type }}}</span></li>
                                    @endif
                        ...
                        <div class="wt-proposalamount-holder">
                            ...
                            {!! Form::open(['url' => url('Job/proposal/submit-proposal'), 'class' =>'wt-haslayout', 'id' => 'send-propsal',  '@submit.prevent'=>'submitJobProposal('.$job->id.')']) !!}
                                ...
                                <div class="wt-formtheme wt-formproposal">
                                    ...
                                    <div class="wt-attachments wt-attachmentsvtwo wt-attachmentsholder lara-proposal-attachment">
                                        <div class="lara-attachment-files">
                                            ...
                                            <job_attachments :temp_url="'{{url('Job/proposal/upload-temp-image')}}'"></job_attachments>
