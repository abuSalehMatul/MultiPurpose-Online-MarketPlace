@if( Schema::hasTable('job_site_managements'))
    @php
                                    ...
                                    @if(!empty($footer['menu_pages_1']))
                                        <ul class="wt-fwidgetcontent">
                                            @foreach($footer['menu_pages_1'] as $menu_1_page)
                                                ...
                                                @if (!empty($page))
                                                    <li><a href="{{{ url('Job/page/'.$page->slug) }}}">{{{ $page->title }}}</a></li>
                                                @endif
                                            @endforeach
                                        </ul>
                                    @endif
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <p class="wt-copyrights"><span>{{{ !empty($footer['copyright']) ? $footer['copyright'] : 'Mthech. All rights reserved.'  }}}</p>
