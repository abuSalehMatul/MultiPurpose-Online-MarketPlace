                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            @include('job.front-end.employers.filters')
                        </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                                <div class="wt-companysdetails">
                                                    ...
                                                    <div class="wt-companysinfo">
                                                        ...
                                                        <div class="wt-title">
                                                            <a href="{{{ url('Job/profile/'.$employer->slug) }}}">
                                                            @if ($verified_user === 1)
                                                                <i class="fa fa-check-circle"></i> {{ trans('lang.verified_company') }}</a>
                                                            @endif
                                                            <a href="{{{ url('Job/profile/'.$employer->slug) }}}"><h2>{{{ Helper::getUserName($employer->id) }}}</h2></a>
                                                        </div>
