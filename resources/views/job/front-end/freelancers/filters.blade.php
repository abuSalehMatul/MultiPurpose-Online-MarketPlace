<aside id="wt-sidebar" class="wt-sidebar wt-usersidebar">
    {!! Form::open(['url' => url('Job/search-results'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch']) !!}
                        ...
                        <div class="wt-checkboxholder wt-verticalscrollbar">
                            @foreach ($locations as $location)
                                ...
                                <span class="wt-checkbox">
                                    ...
                                    <label for="location-{{{ $location->slug }}}"> <img src="{{{asset(App\JobModel\JobHelper::getLocationFlag($location->flag))}}}" alt="{{ trans('lang.img') }}"> {{{ $location->title }}}</label>
                                </span>
                            @endforeach
                        </div>
                    @endif
