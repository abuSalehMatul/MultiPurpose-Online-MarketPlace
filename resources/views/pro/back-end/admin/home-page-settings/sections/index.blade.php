...
@include('pro.back-end.admin.home-page-settings.sections.explore-categories')
<div class="wt-tabscontenttitle la-switch-option">
    ...
    @include('pro.back-end.admin.home-page-settings.sections.background-image')
    @include('pro.back-end.admin.home-page-settings.sections.start-as')
<div class="wt-tabscontenttitle la-switch-option">
...
@include('pro.back-end.admin.home-page-settings.sections.download-app')
