...
@section('content')
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="{{route('social.index')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Edit Social Icons</h4> 
    {!! Form::model($social1, ['method' => 'PATCH', 'action' => ['SocialController@update', $social1->id]]) !!}
