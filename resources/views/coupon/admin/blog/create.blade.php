...
@section('content') 
  <div class="admin-form-main-block mrgn-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/blog')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Add Blog</h4> 
      ...
      <div class="row admin-form-block z-depth-1">
        <div class="col-md-8">
          ...
          <div class="form-group{{ $errors->has('tag') ? ' has-error' : '' }}">
              {!! Form::label('tag', 'Tags*') !!} - <p class="inline info">Please select or create new tags using comma or space</p>
