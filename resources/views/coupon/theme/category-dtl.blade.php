		...
		<div class="container">
			<div class="forum-page-header">
				<div class="forum-page-heading-block">
					<h5 class="forum-page-heading">{{$category->title}} Deals & Coupons</h5>
				</div>
			</div>
			<!-- breadcrumb -->
			<div id="breadcrumb" class="breadcrumb-main-block">
	          ...
	          <li><a href="{{url('category')}}" title="Categories">Categories</a></li>
								...
								@if(isset($store_list) && count($store_list)>0)
									<div class="page-sidebar-widget categories-widget">
						      		...
						      		<div class="checkbox-main-group">
							      		<ul id="catList" class="form-group" data-store="{{$category->id}}" data-type="store">
