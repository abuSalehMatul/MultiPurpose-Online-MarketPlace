				...
				<div class="slider-btn">
					<div class="row">
						<div class="col-md-6 text-right">
							<a href="{{$settings->btn_link}}" class="btn btn-primary" title="{{$settings->btn_title}}">{{$settings->btn_title}}</a>
						</div>
						<div class="col-md-6 text-left">
							<a href="{{$settings->btn_link2}}" class="btn btn-primary" title="{{$settings->btn_title2}}">{{$settings->btn_title2}}</a>
						</div>
					</div>
				</div>
			</div>
...
<!-- deal -->
	<section id="deal" class="deal-main-block">
		<div class="container">
			@if(isset($settings) && $settings->is_feat_slider)
				<div class="featured-deal-main">
					@if(isset($feat_deal) && count($feat_deal) > 0)
						<div class="section">
