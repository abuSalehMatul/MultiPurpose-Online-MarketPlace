		...
		<div class="container">
			<div class="forum-page-header">
				<div class="forum-page-heading-block">
					<h5 class="forum-page-heading">Exclusive Store Coupons</h5>
				</div>
			</div>
			<!-- breadcrumb -->
			<div id="breadcrumb" class="breadcrumb-main-block">
				<div class="breadcrumb-block">
					<ol class="breadcrumb">
						...
						<li><a href="{{url('coupon')}}" title="Coupons">Coupons</a></li>
								...
								@if(isset($category_list) && count($category_list)>0)
									<div class="page-sidebar-widget categories-widget">
						      		...
						      		<div class="checkbox-main-group">
							      		<ul id="catList" class="form-group" data-store="{{$store->id}}" data-type="categorycoupon">
