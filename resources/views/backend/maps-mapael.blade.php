...
@section('script')
        ...
        <script src="{{ URL::asset('backend/assets/libs/jquery-mapael/jquery-mapael.min.js')}}"></script>
        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/mapeal-maps.init.js')}}"></script>
