                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">28/78</span></p>
                            ...
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Title-->
                                    <h4 class="mt-0"><a href="javascript: void(0);" class="text-dark">App Design and Development</a></h4>
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">55/85</span></p>
                                    <div class="progress mb-1" style="height: 7px;">
                                        <div class="progress-bar"
                            ...
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Title-->
                                    <h4 class="mt-0"><a href="javascript: void(0);" class="text-dark">Landing page Design</a></h4>
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">21/42</span></p>
                                    <div class="progress mb-1" style="height: 7px;">
                                        <div class="progress-bar"
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Title-->
                                    <h4 class="mt-0"><a href="javascript: void(0);" class="text-dark">Custom Software Development</a></h4>
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">70/95</span></p>
                                    <div class="progress mb-1" style="height: 7px;">
                                        <div class="progress-bar"
                            ...
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Title-->
                                    <h4 class="mt-0"><a href="javascript: void(0);" class="text-dark">Website Redesign</a></h4>
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">12/36</span></p>
                                    <div class="progress mb-1" style="height: 7px;">
                                        <div class="progress-bar"
                            ...
                            <div class="col-xl-4">
                                <div class="card-box project-box">
                                    ...
                                    <!-- Title-->
                                    <h4 class="mt-0"><a href="javascript: void(0);" class="text-dark">Multipurpose Landing Template</a></h4>
                                    ...
                                    <!-- Progress-->
                                    <p class="mb-2 font-weight-bold">Task completed: <span class="float-right">28/30</span></p>
                                    <div class="progress mb-1" style="height: 7px;">
                                        <div class="progress-bar"
