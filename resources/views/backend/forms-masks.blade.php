...
@section('script')
        ...
        <!-- Plugins js -->
        <script src="{{ URL::asset('backend/assets/libs/jquery-mask-plugin/jquery-mask-plugin.min.js')}}"></script>
        <script src="{{ URL::asset('backend/assets/libs/autonumeric/autonumeric.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/form-masks.init.js')}}"></script>
