...
@section('css')
        <!-- Loading button css -->
        <link href="{{ URL::asset('backend/assets/libs/ladda/ladda.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Loading buttons js -->
        <!-- <script src="{{ URL::asset('backend/assets/libs/ladda/spin.js')}}"></script> -->
        <script src="{{ URL::asset('backend/assets/libs/ladda/ladda.min.js')}}"></script>

        <!-- Buttons init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/loading-btn.init.js')}}"></script>
