...
@section('content')
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">178</span></h3>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">289</span></h3>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">1021</span></h3>
                            ...
                            <div class="col-md-6 col-xl-3">
                                <div class="widget-rounded-circle card-box">
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <h3 class="text-dark mt-1"><span data-plugin="counterup">154</span>k</h3>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart text-center" dir="ltr">
                                        <input data-plugin="knob" data-width="120" data-height="120" data-linecap=round data-fgColor="#f1556c" value="60" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".12"/>
                            ...
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart text-center" dir="ltr">
                                        <input data-plugin="knob" data-width="120" data-height="120" data-linecap=round data-fgColor="#6658dd" value="37" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".12"/>
                                        <h5 class="text-muted mt-3">Total sales made today</h5>
                                        <h2>29</h2>
                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="card-box">
                                    <h4 class="header-title mb-3">Lifetime Sales</h4>
...
@section('script')
        ...
        <!-- Plugins js -->
        <script src="{{ URL::asset('backend/assets/libs/peity/peity.min.js')}}"></script>
        ...
        <script src="{{ URL::asset('backend/assets/libs/jquery-scrollto/jquery-scrollto.min.js')}}"></script>
        <script src="{{ URL::asset('backend/assets/libs/sweetalert2/sweetalert2.min.js')}}"></script>

        <!-- Chat js -->
        <script src="{{ URL::asset('backend/assets/js/pages/jquery.chat.js')}}"></script>

        <!-- TODO js-->
        <script src="{{ URL::asset('backend/assets/js/pages/jquery.todo.js')}}"></script>

        <!-- Widgets demo js-->
        <script src="{{ URL::asset('backend/assets/js/pages/widgets.init.js')}}"></script>
