...
@section('css')
        ...
        <!-- Plugins css -->
        <link href="assets/libs/nestable2/nestable2.min.css" rel="stylesheet" />
...
@section('script')
        ...
        <!-- Plugins js-->
        <script src="{{ URL::asset('backend/assets/libs/nestable2/nestable2.min.js')}}"></script>

        <!-- Nestable init-->
        <script src="{{ URL::asset('backend/assets/js/pages/nestable.init.js')}}"></script>
