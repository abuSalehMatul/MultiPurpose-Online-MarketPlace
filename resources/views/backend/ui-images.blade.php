                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <div class="media mb-3">
                                        <img class="d-flex mr-3 rounded-circle" src="assets/images/users/user-10.jpg" alt="Generic placeholder image" height="64">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <div class="media mb-3">
                                        <img class="d-flex align-self-start rounded mr-3" src="assets/images/users/user-5.jpg" alt="Generic placeholder image" height="64">
                                        <div class="media-body">
                                    ...
                                    <div class="media mb-3">
                                        <img class="d-flex align-self-center rounded mr-3" src="assets/images/users/user-6.jpg" alt="Generic placeholder image" height="64">
                                        <div class="media-body">
                                    ...
                                    <div class="media">
                                        <img class="d-flex align-self-end rounded mr-3" src="assets/images/users/user-7.jpg" alt="Generic placeholder image" height="64">
                                        <div class="media-body">
