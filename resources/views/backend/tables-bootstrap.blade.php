...
@section('css')
        ...
        <link href="{{ URL::asset('backend/assets/libs/bootstrap-table/bootstrap-table.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Bootstrap Tables js -->
        <script src="{{ URL::asset('backend/assets/libs/bootstrap-table/bootstrap-table.min.js')}}"></script>

        <!-- Init js -->
        <script src="{{ URL::asset('backend/assets/js/pages/bootstrap-tables.init.js')}}"></script>
