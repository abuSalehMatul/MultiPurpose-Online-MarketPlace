...
@section('css')
        <!-- Plugins css -->
        <link href="{{ URL::asset('backend/assets/libs/x-editable/x-editable.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/assets/libs/x-editable/x-editable.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/form-xeditable.init.js')}}"></script>
