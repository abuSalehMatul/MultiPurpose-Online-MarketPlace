...
@section('css')
        <!-- ION Slider -->
        <link href="{{ URL::asset('backend/assets/libs/ion-rangeslider/ion-rangeslider.min.css')}}" rel="stylesheet" type="text/css"/>
@endsection
...
@section('script')
        ...
        <!-- Ion Range Slider-->
        <script src="{{ URL::asset('backend/assets/libs/ion-rangeslider/ion-rangeslider.min.js')}}"></script>

        <!-- Range slider init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/range-sliders.init.js')}}"></script>
