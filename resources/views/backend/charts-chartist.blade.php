...
@section('css')
        <!-- Chartist Chart CSS -->
        <link rel="stylesheet" href="{{ URL::asset('backend/assets/libs/chartist/chartist.min.css')}}">
@endsection
...
@section('script')
        ...
        <!--Chartist Chart-->
        <script src="{{ URL::asset('backend/assets/libs/chartist/chartist.min.js')}}"></script>
        <!-- Init js -->
        <script src="{{ URL::asset('backend/assets/js/pages/chartist.init.js')}}"></script>
