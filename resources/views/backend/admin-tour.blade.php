...
@section('css')
        <!-- Tour css -->
        <link href="{{ URL::asset('backend/assets/libs/hopscotch/hopscotch.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
                            ...
                            <div class="col-12">
                                <div class="card-box">
                                    <div class="text-center">
                                        <img src="assets/images/logo-dark.png" alt="" height="18" id="logo-tour">
                                    </div>
                                    ...
                                    <div class="text-center mt-4">
                                        <a href="javascript: void(0);" class="btn btn-danger waves-effect waves-light" id="thankyou-tour">Thank you !</a>
                                    </div>
...
@section('script')
        ...
        <!-- Tour page js -->
        <script src="{{ URL::asset('backend/assets/libs/hopscotch/hopscotch.min.js')}}"></script>

        <!-- Tour init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/tour.init.js')}}"></script>
