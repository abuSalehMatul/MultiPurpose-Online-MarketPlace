...
@section('css')
        <!-- Jquery Toast css -->
        <link href="{{ URL::asset('backend/assets/libs/jquery-toast/jquery-toast.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Tost-->
        <script src="{{ URL::asset('backend/assets/libs/jquery-toast/jquery-toast.min.js')}}"></script>

        <!-- toastr init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/toastr.init.js')}}"></script>
