...
@section('css')
        <!-- Animation css -->
        <link href="{{ URL::asset('backend/assets/libs/animate/animate.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        <!-- demo animation-->
        <script src="{{ URL::asset('assets/js/pages/animation.init.js')}}"></script>
@endsection