...
@section('css')
        <!-- Ricksaw Css-->
        <link href="{{ URL::asset('backend/assets/libs/rickshaw/rickshaw.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Ricksaw js-->
        <script src="{{ URL::asset('backend/assets/libs/rickshaw/rickshaw.min.js')}}"></script>

        <!-- init js -->
        <script src="{{ URL::asset('backend/assets/js/pages/ricksaw.init.js')}}"></script>
