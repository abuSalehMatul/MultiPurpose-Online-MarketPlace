                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Unsticky Header</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Unsticky Header</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
...
@section('script')
        ...
        <!-- Dashboard init-->
        <script src="{{ URL::asset('backend/assets/js/pages/dashboard-4.init.js')}}"></script>
