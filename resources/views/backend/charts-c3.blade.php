...
@section('css')
        <!-- C3 Chart css -->
        <link href="{{ URL::asset('backend/assets/libs/c3/c3.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!--C3 Chart-->
        <script src="{{ URL::asset('backend/assets/libs/d3/d3.min.js')}}"></script>
        <script src="{{ URL::asset('backend/assets/libs/c3/c3.min.js')}}"></script>

        <!-- Init js -->
        <script src="{{ URL::asset('backend/assets/js/pages/c3.init.js')}}"></script>
