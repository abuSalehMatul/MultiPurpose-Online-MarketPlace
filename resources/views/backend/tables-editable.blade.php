...
@section('script')
        ...
        <script src="{{ URL::asset('backend/assets/libs/jquery-tabledit/jquery-tabledit.min.js')}}"></script>

        <!-- Table editable init-->
        <script src="{{ URL::asset('backend/assets/js/pages/tabledit.init.js')}}"></script>
