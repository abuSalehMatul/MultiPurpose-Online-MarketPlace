...
@section('body')
    <body class="menubar-light topbar-dark">
@endsection
                        ...
                        <div class="page-title-box">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <li class="breadcrumb-item active">Menubar Light</li>
                                </ol>
                            </div>
                            <h4 class="page-title">Menubar Light</h4>
                        </div>
                    </div>
                </div>     
                <!-- end page title --> 
...
@section('script')
        ...
        <script src="{{URL::asset('backend/assets/libs/jquery-vectormap/jquery-vectormap.min.js')}}"></script>

        <!-- Dashboard 2 init -->
        <script src="{{ URL::asset('backend/assets/js/pages/dashboard-2.init.js')}}"></script>
