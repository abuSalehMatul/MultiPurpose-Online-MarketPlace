...
@section('script')
        ...
        <!-- Plugins js-->
        <script src="{{ URL::asset('backend/assets/libs/twitter-bootstrap-wizard/twitter-bootstrap-wizard.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/form-wizard.init.js')}}"></script>
