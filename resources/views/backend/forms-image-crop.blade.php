...
@section('css')
        <!-- Cropper css -->
        <link href="{{ URL::asset('backend/assets/libs/cropper/cropper.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
                                        ...
                                        <div class="row">
                                            <div class="col-lg-9">
                                                <div class="img-container">
                                                    <img id="image" src="assets/images/small/img-2.jpg" alt="Picture" class="img-fluid">
                                                </div>
                                            </div>
                                            <div class="col-lg-3">
...
@section('script')
        ...
        <!-- Plugins js -->
        <script src="{{ URL::asset('backend/assets/libs/cropper/cropper.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/form-imagecrop.init.js')}}"></script>
