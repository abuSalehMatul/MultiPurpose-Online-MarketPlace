...
@section('css')
        <!-- Lightbox css -->
        <link href="{{ URL::asset('backend/assets/libs/magnific-popup/magnific-popup.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Magnific Popup-->
        <script src="{{ URL::asset('backend/assets/libs/magnific-popup/magnific-popup.min.js')}}"></script>

        <!-- Gallery Init-->
        <script src="{{ URL::asset('backend/assets/js/pages/gallery.init.js')}}"></script>
