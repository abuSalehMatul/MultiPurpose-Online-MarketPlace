...
@section('css')
        <!-- Footable css -->
        <link href="{{ URL::asset('backend/assets/libs/footable/footable.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Footable js -->
        <script src="{{ URL::asset('backend/assets/libs/footable/footable.min.js')}}"></script>

        <!-- Init js -->
        <script src="{{ URL::asset('backend/assets/js/pages/foo-tables.init.js')}}"></script>
