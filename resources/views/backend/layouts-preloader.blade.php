...
@section('css')
        <!-- plugin css -->
        <link href="{{ URL::asset('backend/assets/libs/jquery-vectormap/jquery-vectormap.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Chart JS -->
        <script src="{{ URL::asset('backend/assets/libs/chart-js/chart-js.min.js')}}"></script>
        ...
        <!-- Dashboard init JS -->
        <script src="{{ URL::asset('backend/assets/js/pages/dashboard-3.init.js')}}"></script>
