...
@section('css')
        ...
        <link href="{{ URL::asset('backend/assets/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ URL::asset('backend/assets/libs/clockpicker/clockpicker.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ URL::asset('backend/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <script src="{{ URL::asset('backend/assets/libs/bootstrap-colorpicker/bootstrap-colorpicker.min.js')}}"></script>
        <script src="{{ URL::asset('backend/assets/libs/clockpicker/clockpicker.min.js')}}"></script>
        <script src="{{ URL::asset('backend/assets/libs/bootstrap-datepicker/bootstrap-datepicker.min.js')}}"></script>

        <!-- Init js-->
        <script src="{{ URL::asset('backend/assets/js/pages/form-pickers.init.js')}}"></script>
