...
class JobPageController extends Controller
{
    ...
    public function index()
    {
        ...
        return View::make(
            'job.back-end.admin.pages.index',
            compact('pages')
        );
    }
    ...
    public function create()
    {
        ...
        return View::make('job.back-end.admin.pages.create', compact('parent_page', 'page_created'));
    }
    ...
    public function show($slug)
    {
        if (!empty($slug)) {
            ...
            $page_meta = JobSiteManagement::where('meta_key', 'seo-desc-'.$page->id)->select('meta_value')->pluck('meta_value')->first();
            $meta_desc = !empty($page_meta) ? $page_meta : '';
            if (file_exists(resource_path('views/extend/front-end/pages/show.blade.php'))) {
                return View::make('job.extend.front-end.pages.show', compact('page', 'slug', 'meta_desc'));    
            } else {
                return View::make('job.front-end.pages.show', compact('page', 'slug', 'meta_desc'));
            }
        }
    }
    ...
    public function edit($id)
    {
        if (!empty($id)) {
            ...
            $desc = JobSiteManagement::where('meta_key', 'seo-desc-'.$id)->select('meta_value')->pluck('meta_value')->first();
            ...
            return View::make('job.back-end.admin.pages.edit', compact('page', 'parent_page', 'parent_selected_id', 'id', 'has_child', 'seo_desc'));
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($server_verification)) {
            ...
            return Redirect::to('Job/admin/pages');
        }
        if (!empty($request)) {
            $this->validate(
                $request, [
