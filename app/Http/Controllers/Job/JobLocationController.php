...
class JobLocationController extends Controller
{
     ...
     * @return void
     */
    public function __construct(JobLocation $location)
    {
    ...
    public function index()
    {
        ...
        return View::make(
            'job.back-end.admin.locations.index',
            compact('locations')
        );
    }
