 ...
 *
 */
class JobEmailTemplateController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return View::make('job.back-end.admin.email-templates.index', compact('templates'));
    }
    ...
    public function edit($id)
    {
        ...
        return View::make('job.back-end.admin.email-templates.edit', compact('template'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if (!empty($server_verification)) {
            ...
            return Redirect::to('Job/admin/email-templates');
        }
        $this->validate(
            $request, [
                'title' => 'required',
