 ...
 *
 */
class JobBadgeController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return View::make(
            'job.back-end.admin.badges.index',
    ...
    public function edit($id)
    {
        if (!empty($id)) {
            ...
            if (!empty($badges)) {
                return View::make(
                    'job.back-end.admin.badges.edit',
                    compact('id', 'badges')
                );
    ...
    {
        $path = JobHelper::PublicPath() . '/uploads/badges/temp/';
