...
class JobDepartmentController extends Controller
{
     ...
     * @return void
     */
    public function __construct(JobDepartment $department)
    {
    ...
    public function index(Request $request)
    {
        ...
        return View::make(
            'job.back-end.admin.departments.index',
            compact('departments')
        );
    }
    ...
    public function edit($id)
    {
        if (!empty($id)) {
            ...
            if (!empty($departments)) {
                return View::make(
                    'job.back-end.admin.departments.edit', compact('id', 'departments')
                );
                Session::flash('message', trans('lang.dpt_updated'));
                return Redirect::to('Job/admin/departments');
            }
        }
    }
