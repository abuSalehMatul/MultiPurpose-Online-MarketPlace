    ...
    public function getUsers()
    {
        ...
        if (!empty($users)) {
            foreach ($users as $key => $userVal) {
                ...
                $json[$key]['image'] = JobHelper::getProfileImage($chat_user_id);
                $json[$key]['name'] = JobHelper::getUserName($chat_user_id);
    ...
    public function getUserMessages(Request $request)
    {
        ...
        if (!empty($request['sender_id'])) {
            ...
            foreach ($messages as $key => $message) {
                ...
                $json['messages'][$key]['image'] = url(JobHelper::getProfileImage($message->user_id));
            ...
            $json['selected']['selected_user_name'] = JobHelper::getUserName($receiver_id);
            $json['selected']['selected_user_slug'] = $selected_user->slug;
            $json['selected']['selected_user_tagline'] = $selected_user->profile->tagline;
            $json['selected']['selected_user_image'] = url(JobHelper::getProfileImage($receiver_id));
