...
class ProLocationController extends Controller
{
     ...
     * @return void
     */
    public function __construct(ProLocation $location)
    {
    ...
    public function index()
    {
        ...
        return View::make(
            'pro.back-end.admin.locations.index',
            compact('locations')
        );
    }
