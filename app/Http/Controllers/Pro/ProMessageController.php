 ...
 *
 */
class ProMessageController extends Controller
{
    protected $message;
    ...
    public function getUsers()
    {
        ...
        if (!empty($users)) {
            foreach ($users as $key => $userVal) {
                ...
                $json[$key]['image'] = ProHelper::getProfileImage($chat_user_id);
                $json[$key]['name'] = ProHelper::getUserName($chat_user_id);
    ...
    public function getUserMessages(Request $request)
    {
        ...
        if (!empty($request['sender_id'])) {
            ...
            foreach ($messages as $key => $message) {
                ...
                $json['messages'][$key]['image'] = url(ProHelper::getProfileImage($message->user_id));
            ...
            $json['selected']['selected_user_name'] = ProHelper::getUserName($receiver_id);
            $json['selected']['selected_user_slug'] = $selected_user->slug;
            $json['selected']['selected_user_tagline'] = $selected_user->profile->tagline;
            $json['selected']['selected_user_image'] = url(ProHelper::getProfileImage($receiver_id));
