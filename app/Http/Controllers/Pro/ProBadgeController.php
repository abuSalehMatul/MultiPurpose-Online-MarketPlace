...
class BadgeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return View::make(
            'pro.back-end.admin.badges.index',
    ...
    public function edit($id)
    {
        if (!empty($id)) {
            ...
            if (!empty($badges)) {
                return View::make(
                    'pro.back-end.admin.badges.edit',
                    compact('id', 'badges')
                );
    ...
    {
        $path = ProHelper::PublicPath() . '/uploads/badges/temp/';
