 ...
 *
 */
class ProReviewController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return View::make(
            'pro.back-end.admin.review-options.index',
    ...
    public function edit($id)
    {
        if (!empty($id)) {
            ...
            if (!empty($review_options)) {
                return View::make(
                    'pro.back-end.admin.review-options.edit', compact('id', 'review_options')
                );
                Session::flash('message', trans('lang.review_options_updated'));
                return Redirect::to('Pro/admin/review_options');
            }
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::to('Pro/admin/review-options');
    }
