...
class JobProposal extends Model
{
    ...
    public function job()
    {
        return $this->belongsTo('App\JobModel\ModelJob');
    }
    ...
    {
        return $this->morphOne('App\JobModel\JobReport', 'reportable');
    }
    ...
    {
        return JobProposal::select('id', 'amount', 'updated_at')->latest()
