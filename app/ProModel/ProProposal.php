 ...
 *
 */
class ProProposal extends Model
{
    ...
    public function job()
    {
        return $this->belongsTo('App\ProModel\ModelJob');
    }
    ...
    {
        return $this->morphOne('App\ProModel\ProReport', 'reportable');
    }
    ...
    {
        return ProProposal::select('id', 'amount', 'updated_at')->latest()
