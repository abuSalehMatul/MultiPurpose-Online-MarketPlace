...
class ProPage extends Model
{
    ...
    public function updatePage($id, $request)
    {
        if (!empty($id) && !empty($request)) {
            ...
            $pages->save();
            if (!empty($request['seo_desc'])) {
                DB::table('pro_site_managements')->where('meta_key', '=', 'seo-desc-'.$id)->delete();
                DB::table('pro_site_managements')->insert(
                    [
            ...
            if (!empty($request['show_page'])) {
                DB::table('pro_site_managements')->where('meta_key', '=', 'show-page-'.$id)->delete();
                DB::table('pro_site_managements')->insert(
                    [
