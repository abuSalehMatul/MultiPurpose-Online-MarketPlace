                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 float-right">
                    <div class="wt-dashboardbox">
                        <div class="wt-dashboardboxtitle wt-titlewithsearch">
                            ...
                            <a href="javascript:void(0);" v-if="this.is_show" @click="deleteChecked('<?php echo e(trans('lang.ph_delete_confirm_title')); ?>', '<?php echo e(trans('lang.ph_dpt_delete_message')); ?>')" class="wt-skilldel">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dpt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="del-<?php echo e($dpt->id); ?>" v-bind:id="dptID">
                                                <td>
                                                    <span class="wt-checkbox">
                                                        <input name="dpts[]" @click="selectRecord" value="<?php echo e($dpt->id); ?>" id="wt-check-<?php echo e($counter); ?>" type="checkbox" name="head">
