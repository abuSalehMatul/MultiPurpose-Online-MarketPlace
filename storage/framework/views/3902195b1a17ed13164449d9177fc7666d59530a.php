<?php if(Schema::hasTable('pages') || Schema::hasTable('job_site_managements')): ?>
    <?php
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php endif; ?>
                    <?php if(!empty($logo) || Schema::hasTable('job_site_managements')): ?>
                        <strong class="wt-logo"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset($logo)); ?>" alt="<?php echo e(trans('Logo')); ?>"></a></strong>
                    <?php endif; ?>
                    <?php if(!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/job' && Route::getCurrentRoute()->uri() != 'home'): ?>
                        <search-form
                        :placeholder="'<?php echo e(trans('lang.looking_for')); ?>'"
                        :freelancer_placeholder="'<?php echo e(trans('lang.search_filter_list.candidate')); ?>'"
                        :employer_placeholder="'<?php echo e(trans('lang.search_filter_list.company')); ?>'"
                        :job_placeholder="'<?php echo e(trans('lang.search_filter_list.circular')); ?>'"
                        ...
                        <nav id="wt-nav" class="wt-nav navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse wt-navigation" id="navbarNav">
                                <ul class="navbar-nav">
                                        ...
                                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($page->relation_type == 0 && $show_page == 'true'): ?>
                                                <li class="<?php echo e(!empty($page_has_child) ? 'menu-item-has-children page_item_has_children' : ''); ?> <?php if($pageID == $page->slug ): ?> current-menu-item <?php endif; ?>">
                                                    <a href="<?php echo e(url('Job/page/'.$page->slug)); ?>"><?php echo e($page->title); ?></a>
                                                        ...
                                                        <ul class="sub-menu">
                                                            <?php $__currentLoopData = $page_has_child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <li class="<?php if($pageID == $child->slug ): ?> current-menu-item <?php endif; ?>">
                                                                    <a href="<?php echo e(url('Job/page/'.$child->slug.'/')); ?>">
                                    ...
                                    <?php endif; ?>
                                    <li>
                                        <a href="<?php echo e(url('Job/search-results?type=candidate')); ?>">
                                            <?php echo e(trans('lang.view_candidate')); ?>

                                        </a>
                                    </li>
                                   
                                    <li>
                                        <a href="<?php echo e(url('Job/search-results?type=employer')); ?>">
                                            <?php echo e(trans('lang.view_company')); ?>

                                        </a>
                                    </li>
                                   
                                    <li>
                                        <a href="<?php echo e(url('Job/search-results?type=job')); ?>">
                                            <?php echo e(trans('lang.browse_circular')); ?>
                            ...
                            ?>
                                <div class="wt-userlogedin">
                                    ...
                                    <div class="wt-username">
                                        ...
                                        <span><?php echo e(( Auth::user()->hasRole('candidate')) ? 'Candidate' : ''); ?></span>
                                    </div>
                                   
                                    <?php echo $__env->make('job.back-end.includes.profile-menu', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                        <?php endif; ?>
