        ...
        <ul>
            <?php if($role === 'admin'): ?>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?php echo e(url('admin/pages')); ?>"><?php echo e(trans('lang.all_pages')); ?></a></li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="<?php echo e(url('admin/profile')); ?>"><?php echo e(trans('lang.acc_settings')); ?></a></li>
                        <li><a href="<?php echo e(url('admin/settings')); ?>"><?php echo e(trans('lang.general_settings')); ?></a></li>
