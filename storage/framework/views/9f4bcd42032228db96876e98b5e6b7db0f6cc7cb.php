<?php if( Schema::hasTable('pro_site_managements')): ?>
    <?php
                        ...
                        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                            <div class="wt-footerlogohold">
                                <?php if(!empty($footer['footer_logo'])): ?>
                                    <strong class="wt-logo"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset(\App\ProModel\ProHelper::getFooterLogo($footer['footer_logo']))); ?>" alt="company logo here"></a></strong>
                                <?php endif; ?>
                                    ...
                                    <?php if(!empty($footer['menu_pages_1'])): ?>
                                        <ul class="wt-fwidgetcontent">
                                            <?php $__currentLoopData = $footer['menu_pages_1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_1_page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(!empty($page)): ?>
                                                    <li><a href="<?php echo e(url('Pro/page/'.$page->slug)); ?>"><?php echo e($page->title); ?></a></li>
                                                <?php endif; ?>
