<aside id="wt-sidebar" class="wt-sidebar wt-usersidebar">
    <?php echo Form::open(['url' => url('Job/search-results'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch']); ?>
                        ...
                        <div class="wt-checkboxholder wt-verticalscrollbar">
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <span class="wt-checkbox">
                                    ...
                                    <label for="location-<?php echo e($location->slug); ?>"> <img src="<?php echo e(asset(App\JobModel\JobHelper::getLocationFlag($location->flag))); ?>" alt="<?php echo e(trans('lang.img')); ?>"> <?php echo e($location->title); ?></label>
                                </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
        ...
        <div class="wt-widget wt-effectiveholder">
            ...
            <div class="wt-widgetcontent">
                <fieldset>
                    <div class="form-group">
                        <input type="text" class="form-control filter-records" placeholder="Search Language">
                        <a href="javascrip:void(0);" class="wt-searchgbtn"><i class="lnr lnr-magnifier"></i></a>
                    </div>
                </fieldset>
                <fieldset>
