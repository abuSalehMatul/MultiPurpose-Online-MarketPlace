...
<!-- Modal -->
            ...
            <div class="modal-dialog" role="document">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(url('verification_user')); ?>" id="from" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?php echo e(url('reset_pin')); ?>" type="button" class="btn btn-primary">Reset PIN</a>
                </div>
                </div>
            </div>
            </div>
        ...
        function showpin(data){
            type=data;
             document.getElementById("type").setAttribute('value',data);
                $.ajax({
                url: "<?php echo e(url('verification_user_ajax')); ?>",
                type: 'get',
