...
<?php $__env->stopPush(); ?>
<?php $__env->startSection('title'); ?><?php echo e(trans('lang.freelancers')); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('description', 'This is freelancer view description tag'); ?>
            ...
            <div id="wt-categoriesslider" class="wt-categoriesslider owl-carousel">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="wt-categoryslidercontent item <?php echo e($active_wrapper); ?>">
                        ...
                        <h3><a href="<?php echo e(url('Pro/search-results?type=job&category%5B%5D='.$cat->slug)); ?>" class="<?php echo e($active); ?>"><?php echo e($cat->title); ?></a></h3>
                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            <?php echo $__env->make('pro.front-end.freelancers.filters', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                            <div class="wt-userlistingholder wt-userlisting wt-haslayout">
                                ...
                                <?php if(!empty($users)): ?>
                                        ...
                                        <div class="wt-userlistinghold <?php echo e($feature_class); ?>">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="<?php echo e(url('Pro/profile/'.$freelancer->slug)); ?>">
                                                        ...
                                                        <?php if(!empty($freelancer->profile->tagline)): ?>
                                                            <h2><a href="<?php echo e(url('Pro/profile/'.$freelancer->slug)); ?>"><?php echo e($freelancer->profile->tagline); ?></a></h2>
                                                        <?php endif; ?>
                                                    </div>
                                            ...
                                            <?php if(!empty($freelancer->skills)): ?>
                                                <div class="wt-tag wt-widgettag">
                                                    <?php $__currentLoopData = $freelancer->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <a href="<?php echo e(url('Pro/search-results?type=job&skills%5B%5D='.$skill->slug)); ?>"><?php echo e($skill->title); ?></a>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </div>
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php echo $__env->make('pro.errors.no-record', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('pro.front-end.master', ['body_class' => 'wt-innerbgcolor'], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>