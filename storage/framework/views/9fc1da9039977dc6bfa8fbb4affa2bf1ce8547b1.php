            ...
            <div id="wt-categoriesslider" class="wt-categoriesslider owl-carousel">
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="wt-categoryslidercontent item <?php echo e($active_wrapper); ?>">
                        ...
                        <h3><a href="<?php echo e(url('Job/search-results?type=job&category%5B%5D='.$cat->slug)); ?>" class="<?php echo e($active); ?>"><?php echo e($cat->title); ?></a></h3>
                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            <?php echo $__env->make('job.front-end.freelancers.filters', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                                        ...
                                        <div class="wt-userlistinghold <?php echo e($feature_class); ?>">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="<?php echo e(url('Job/profile/'.$freelancer->slug)); ?>">
                                                        ...
                                                        <?php if(!empty($freelancer->profile->tagline)): ?>
                                                            <h2><a href="<?php echo e(url('Job/profile/'.$freelancer->slug)); ?>"><?php echo e($freelancer->profile->tagline); ?></a></h2>
                                                        <?php endif; ?>
                                                    </div>
