<?php if(Schema::hasTable('pages') || Schema::hasTable('pro_site_managements')): ?>
    <?php
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <?php endif; ?>
                    <?php if(!empty($logo) || Schema::hasTable('pro_site_managements')): ?>
                        <strong class="wt-logo"><a href="<?php echo e(url('/')); ?>"><img src="<?php echo e(asset($logo)); ?>" alt="<?php echo e(trans('Logo')); ?>"></a></strong>
                    <?php endif; ?>
                    <?php if(!empty(Route::getCurrentRoute()) && Route::getCurrentRoute()->uri() != '/pro-dashboard' && Route::getCurrentRoute()->uri() != 'home'): ?>
                        <search-form
                        :placeholder="'<?php echo e(trans('lang.looking_for')); ?>'"
                        :freelancer_placeholder="'<?php echo e(trans('lang.search_filter_list.pro')); ?>'"
                        ...
                        <nav id="wt-nav" class="wt-nav navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse wt-navigation" id="navbarNav">
                                <ul class="navbar-nav">
                                        ...
                                        <?php $__currentLoopData = $pages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <?php if($page->relation_type == 0 && $show_page == 'true'): ?>
                                                <li class="<?php echo e(!empty($page_has_child) ? 'menu-item-has-children page_item_has_children' : ''); ?> <?php if($pageID == $page->slug ): ?> current-menu-item <?php endif; ?>">
                                                    <a href="<?php echo e(url('Pro/page/'.$page->slug)); ?>"><?php echo e($page->title); ?></a>
                                                        ...
                                                        <ul class="sub-menu">
                                                            <?php $__currentLoopData = $page_has_child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $parent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                ...
                                                                <li class="<?php if($pageID == $child->slug ): ?> current-menu-item <?php endif; ?>">
                                                                    <a href="<?php echo e(url('Pro/page/'.$child->slug.'/')); ?>">
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('Pro/search-results?type=pro')); ?>">
                                            <?php echo e(trans('lang.view_pro')); ?>

                                        </a>
                                    </li>
                                    <li>
                                        <a href="<?php echo e(url('Pro/search-results?type=employer')); ?>">
                                    ...
                                    <li>
                                        <a href="<?php echo e(url('Pro/search-results?type=job')); ?>">
                            ...
                            ?>
                                <div class="wt-userlogedin">
                                    ...
                                    <div class="wt-username">
                                        ...
                                        <span><?php echo e(!empty(Auth::user()->pro_profile->tagline) ? str_limit(Auth::user()->profile->tagline, 26, '') : Auth::user()->getRoleNames()->first()); ?></span>
                                    </div>
                                   
                                    <?php echo $__env->make('pro.back-end.includes.profile-menu', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                </div>
                        <?php endif; ?>
