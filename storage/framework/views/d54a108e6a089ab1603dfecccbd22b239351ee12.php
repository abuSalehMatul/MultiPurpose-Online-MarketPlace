<aside id="wt-sidebar" class="wt-sidebar wt-usersidebar">
    <?php echo Form::open(['url' => url('Pro/search-results'), 'method' => 'get', 'class' => 'wt-formtheme wt-formsearch']); ?>
                        ...
                        <div class="wt-checkboxholder wt-verticalscrollbar">
                            <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <span class="wt-checkbox">
                                    ...
                                    <label for="location-<?php echo e($location->slug); ?>"> <img src="<?php echo e(asset(App\ProModel\ProHelper::getLocationFlag($location->flag))); ?>" alt="<?php echo e(trans('lang.img')); ?>"> <?php echo e($location->title); ?></label>
                                </span>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    <?php endif; ?>
