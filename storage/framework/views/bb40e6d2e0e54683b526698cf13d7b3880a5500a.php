<?php if( Schema::hasTable('job_site_managements')): ?>
    <?php
        $footer = \App\JobModel\JobSiteManagement::getMetaValue('footer_settings');
        $search_menu = \App\JobModel\JobSiteManagement::getMetaValue('search_menu');
                                    ...
                                    <?php if(!empty($footer['menu_pages_1'])): ?>
                                        <ul class="wt-fwidgetcontent">
                                            <?php $__currentLoopData = $footer['menu_pages_1']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu_1_page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(!empty($page)): ?>
                                                    <li><a href="<?php echo e(url('Job/page/'.$page->slug)); ?>"><?php echo e($page->title); ?></a></li>
                                                <?php endif; ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <p class="wt-copyrights"><span><?php echo e(!empty($footer['copyright']) ? $footer['copyright'] : 'Mthech. All rights reserved.'); ?></p>
