                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            <?php echo $__env->make('job.front-end.employers.filters', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                                            ...
                                            <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                                <div class="wt-companysdetails">
                                                    ...
                                                    <div class="wt-companysinfo">
                                                        ...
                                                        <div class="wt-title">
                                                            <a href="<?php echo e(url('Job/profile/'.$employer->slug)); ?>">
                                                            <?php if($verified_user === 1): ?>
                                                                <i class="fa fa-check-circle"></i> <?php echo e(trans('lang.verified_company')); ?></a>
                                                            <?php endif; ?>
                                                            <a href="<?php echo e(url('Job/profile/'.$employer->slug)); ?>"><h2><?php echo e(Helper::getUserName($employer->id)); ?></h2></a>
                                                        </div>
