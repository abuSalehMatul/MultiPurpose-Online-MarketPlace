<?php $__env->startSection('css'); ?>
        <!-- Plugins css -->
        <link href="<?php echo e(URL::asset('backend/assets/libs/flatpickr/flatpickr.min.css')); ?>" rel="stylesheet" type="text/css" />
                            ...
                            <div class="col-xl-4">
                                <div class="card-box">
                                    ...
                                    <div class="widget-chart text-center" dir="ltr">
                                        ...
                                        <?php if($payload): ?>
                                        <input data-plugin="knob" data-width="160" data-height="160" data-linecap=round data-fgColor="#f1556c" value="<?php echo e($payload->payload); ?>" data-skin="tron" data-angleOffset="180" data-readOnly=true data-thickness=".12"/>
                                        <h5 class="text-muted mt-3">Total load today</h5>
                                        <h2><?php echo e($payload->payload); ?></h2>
                                        <?php else: ?>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-4">
                                                ...
                                                <?php if($payload): ?>
                                                <h4><i class="fe-arrow-down text-danger mr-1"></i><?php echo e($payload->status); ?></h4>
                                                <?php else: ?> 
...
<?php $__env->startSection('script'); ?>
        <!-- Plugins js-->
        <script src="<?php echo e(URL::asset('backend/assets/libs/flatpickr/flatpickr.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('backend/assets/libs/jquery-knob/jquery-knob.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('backend/assets/libs/jquery-sparkline/jquery-sparkline.min.js')); ?>"></script>
        <script src="<?php echo e(URL::asset('backend/assets/libs/flot-charts/flot-charts.min.js')); ?>"></script>

        <!-- Dashboar 1 init js-->
        <script src="<?php echo e(URL::asset('backend/assets/js/pages/dashboard-1.init.js')); ?>"></script>
<?php $__env->stopSection(); ?>
