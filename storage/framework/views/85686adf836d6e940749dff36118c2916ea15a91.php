<?php $__env->startSection('title'); ?><?php echo e(trans('lang.jobs')); ?> <?php $__env->stopSection(); ?>
<?php $__env->startSection('description', 'This is job view description tag'); ?>
                ...
                <div class="row">
                    <div id="wt-twocolumns" class="wt-twocolumns wt-haslayout">
                        <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-4 float-left">
                            <?php echo $__env->make('job.front-end.jobs.filters', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        </div>
                            ...
                            <div class="wt-userlistingholder wt-haslayout">
                                ...
                                <?php if(!empty($jobs) && $jobs->count() > 0): ?>
                                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                            $job = \App\JobModel\JobJob::find($job->id);
                                        ...
                                        <div class="wt-userlistinghold wt-userlistingholdvtwo <?php echo e($featured_class); ?>">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    <div class="wt-title">
                                                        <a href="<?php echo e(url('Job/profile/'.$job->employer->slug)); ?>"><i class="fa fa-check-circle"></i> <?php echo e(Helper::getUserName($job->employer->id)); ?></a>
                                                        <h2><a href="<?php echo e(url('Job/job/'.$job->slug)); ?>"><?php echo e($job->title); ?></a></h2>
                                                    </div>
                                                    ...
                                                    <div class="wt-tag wt-widgettag">
                                                        <?php $__currentLoopData = $job->skills; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <a href="<?php echo e(url('Job/search-results?type=job&skills%5B%5D='.$skill->slug)); ?>"><?php echo e($skill->title); ?></a>
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    </div>
                                                </div>
                                                <div class="wt-viewjobholder">
                                                    <ul>
                                                        ...
                                                        <li><span><i class="far fa-clock wt-viewjobclock"></i><?php echo e(\App\JobModel\JobHelper::getJobDurationList($job->duration)); ?></span></li>
                                                        ...
                                                        <?php endif; ?>
                                                        <li class="wt-btnarea"><a href="<?php echo e(url('Job/job/'.$job->slug)); ?>" class="wt-btn"><?php echo e(trans('lang.view_job')); ?></a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php echo $__env->make('job.errors.no-record', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('job.front-end.master', ['body_class' => 'wt-innerbgcolor'], \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>