                                                    ...
                                                    <?php if(!in_array($role['id'] == 1, $roles)): ?>
                                                        <li>
                                                            <div class="wt-accordiontitle" id="headingOne" data-toggle="collapse" data-target="#collapseOne">
                                                                ...
                                                                <label for="wt-company-<?php echo e($key); ?>"><?php echo e($role['name']); ?><span> (<?php echo e($role['name'] === 'freelancer' ? trans('lang.signup_as_freelancer') : trans('lang.signup_as_country')); ?>)</span></label>
                                                                </span>
                                                            </div>
